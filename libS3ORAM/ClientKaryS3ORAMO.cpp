...
unsigned long int ClientKaryS3ORAMO::exp_logs[9];
unsigned long int ClientKaryS3ORAMO::thread_max = 0;

char ClientKaryS3ORAMO::timestamp[16];




zmq::context_t** ClientKaryS3ORAMO::context = new zmq::context_t*[NUM_SERVERS];
zmq::socket_t**  ClientKaryS3ORAMO::socket = new zmq::socket_t*[NUM_SERVERS];
 ...
 * @return 0 if successful
 */ 
int ClientKaryS3ORAMO::loadState()
{
...
int ClientKaryS3ORAMO::saveState()
{
 ...
 * @return 0 if successful
 */  
int ClientKaryS3ORAMO::sendORAMTree()
{
 ...
 * @return 0 if successful
 */  
int ClientKaryS3ORAMO::getEvictMatrix(TYPE_INDEX n_evict)
{
	S3ORAM ORAM;
 ...
 * @return 0 if successful
 */  
void* ClientKaryS3ORAMO::thread_socket_func(void* args)
{
...
int ClientKaryS3ORAMO::sendNrecv(int peer_idx, unsigned char* data_out, size_t data_out_size, unsigned char* data_in, size_t data_in_size, int CMD)
{
