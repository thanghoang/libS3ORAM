...
##
## Debug
ProjectName            :=libS3ORAM
ConfigurationName      :=Debug
WorkspacePath          :=/scratch/simulation_thanghoang/libS3ORAM
ProjectPath            :=/scratch/simulation_thanghoang/libS3ORAM/libS3ORAM
...
$(IntermediateDirectory)/ClientS3ORAM.cpp$(ObjectSuffix): ClientS3ORAM.cpp $(IntermediateDirectory)/ClientS3ORAM.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/scratch/simulation_thanghoang/libS3ORAM/libS3ORAM/ClientS3ORAM.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/ClientS3ORAM.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/ServerS3ORAM.cpp$(ObjectSuffix): ServerS3ORAM.cpp $(IntermediateDirectory)/ServerS3ORAM.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/scratch/simulation_thanghoang/libS3ORAM/libS3ORAM/ServerS3ORAM.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/ServerS3ORAM.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/ClientKaryS3ORAMO.cpp$(ObjectSuffix): ClientKaryS3ORAMO.cpp $(IntermediateDirectory)/ClientKaryS3ORAMO.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/scratch/simulation_thanghoang/libS3ORAM/libS3ORAM/ClientKaryS3ORAMO.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/ClientKaryS3ORAMO.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/ServerKaryS3ORAMC.cpp$(ObjectSuffix): ServerKaryS3ORAMC.cpp $(IntermediateDirectory)/ServerKaryS3ORAMC.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/scratch/simulation_thanghoang/libS3ORAM/libS3ORAM/ServerKaryS3ORAMC.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/ServerKaryS3ORAMC.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/ClientBinaryS3ORAMO.cpp$(ObjectSuffix): ClientBinaryS3ORAMO.cpp $(IntermediateDirectory)/ClientBinaryS3ORAMO.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/scratch/simulation_thanghoang/libS3ORAM/libS3ORAM/ClientBinaryS3ORAMO.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/ClientBinaryS3ORAMO.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/ServerKaryS3ORAMO.cpp$(ObjectSuffix): ServerKaryS3ORAMO.cpp $(IntermediateDirectory)/ServerKaryS3ORAMO.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/scratch/simulation_thanghoang/libS3ORAM/libS3ORAM/ServerKaryS3ORAMO.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/ServerKaryS3ORAMO.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/main.cpp$(ObjectSuffix): main.cpp $(IntermediateDirectory)/main.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/scratch/simulation_thanghoang/libS3ORAM/libS3ORAM/main.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/main.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/ClientKaryS3ORAMC.cpp$(ObjectSuffix): ClientKaryS3ORAMC.cpp $(IntermediateDirectory)/ClientKaryS3ORAMC.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/scratch/simulation_thanghoang/libS3ORAM/libS3ORAM/ClientKaryS3ORAMC.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/ClientKaryS3ORAMC.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/Utils.cpp$(ObjectSuffix): Utils.cpp $(IntermediateDirectory)/Utils.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/scratch/simulation_thanghoang/libS3ORAM/libS3ORAM/Utils.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/Utils.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/ServerBinaryS3ORAMO.cpp$(ObjectSuffix): ServerBinaryS3ORAMO.cpp $(IntermediateDirectory)/ServerBinaryS3ORAMO.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/scratch/simulation_thanghoang/libS3ORAM/libS3ORAM/ServerBinaryS3ORAMO.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/ServerBinaryS3ORAMO.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/S3ORAM.cpp$(ObjectSuffix): S3ORAM.cpp $(IntermediateDirectory)/S3ORAM.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/scratch/simulation_thanghoang/libS3ORAM/libS3ORAM/S3ORAM.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/S3ORAM.cpp$(ObjectSuffix) $(IncludePath)
